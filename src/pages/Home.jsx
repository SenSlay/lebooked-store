  ...
  return (
    <main className="h-full">
        <div className="relative bg-[url('../images/hero.jpg')] bg-no-repeat bg-cover bg-center before:absolute before:inset-0 before:bg-black/60 h-[650px] flex justify-center items-center ">
          <div className="relative z-10 p-6 text-white text-center max-w-[700px] min-w-[500px]">
            <h1 className="font-bold text-7xl text-blue-300 mb-4">LeBooked</h1>
            <p className="font-medium text-2xl">Your Next Favorite Read Awaits.</p>
