...
const mockBooks = [
  { id: 1, title: "The Great Gatsby", author: "F. Scott Fitzgerald", image: "img1.jpg" },
  { id: 2, title: "To Kill a Mockingbird", author: "Harper Lee", image: "img2.jpg" },
...
describe("Testing SearchSidebar Component", () => {
  ...
  test("Search Sidebar is on screen when `isOpen` is true", () => {
    render(<SearchSidebar isOpen={true} onClose={vi.fn()} />, { wrapper: MemoryRouter });
  ...
  test("Search Sidebar is hidden when `isOpen` is false", () => {
    render(<SearchSidebar isOpen={false} onClose={vi.fn()} />, { wrapper: MemoryRouter });
  ...
  test("clicking a book calls `onClose`", async () => {
    ...
    render(<SearchSidebar isOpen={true} onClose={onCloseMock} />, { wrapper: MemoryRouter });
