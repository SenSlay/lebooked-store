  ...
  return (
    <Link to={`/books/${book.id}`}>
      <div className="flex flex-col w-[200px] lg:w-[250px] min-h-[450px] text-wrap p-4 bg-slate-200 rounded">
        ...
        <button onClick={(e) => e.preventDefault()} className="border-2 border-solid border-blue-600 uppercase text-blue-600 text-lg font-semibold hover:bg-blue-600 hover:text-white p-0.5">ADD TO CART</button>
      </div>
    </Link>
  )
}
